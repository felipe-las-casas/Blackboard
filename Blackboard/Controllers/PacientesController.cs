...
namespace Blackboard.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public PacientesController(BlackboardContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pacientes != null ? 
                          ...
                          Problem("Entity set 'BlackboardContext.Pacientes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,Nome,Situacao")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("PacienteId,Nome,Situacao")] Paciente paciente)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'BlackboardContext.Pacientes'  is null.");
            }
            var paciente = await _context.Pacientes.FindAsync(id);
            if (paciente != null)
            {
